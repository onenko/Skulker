 ...
 * v2.00 2024-04-26 the notion of 'required' option is removed, unit test added
 * v2.01 2024-06-28 NPE fixed in NanoArgsParserException.toString()
 */
public class NanoArgsParser {
    ...
    public static final class NanoArgsParserException extends RuntimeException {
        ...
        public String toString() {
            String output = "";
            if(option != null) {
                output = "Problem detected when parsing the option -" + option.key + " - ";
            }
            return output + super.getMessage() + " (code " + error + ')';
        }
    }
